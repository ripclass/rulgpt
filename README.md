...
Set `CORS_ORIGINS` to include the live frontend domains. For RuleGPT launch, use:
`["http://localhost:5173","https://www.tfrules.com","https://tfrules.com"]`

For Vercel preview deploys and the live `tfrules.com` cutover, use:
`CORS_ORIGIN_REGEX=^https://([a-z0-9-]+\.)*vercel\.app$|^https://([a-z0-9-]+\.)?tfrules\.com$`
