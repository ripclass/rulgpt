...
_DOMAIN_KEYWORDS = {
    ...
    "fta": (
        ...
        "comesa", "sadc", "ecowas", "eaeu", "efta", "mercosur",
        "pacific alliance", "ceta", "evfta", "korus",
    ),
    "sanctions": (
        ...
        "denied party", "entity list", "bis ", "export license",
        "proliferation", "sanctioned country", "sanctioned entity",
    ),
    "customs": (
    ...
    "bank_specific": (
        ...
        "hsbc", "citibank", "citi ", "jpmorgan", "jp morgan",
        "standard chartered", "deutsche bank", "bnp paribas",
        "société générale", "socgen", "unicredit", "rabobank",
        "commerzbank", "ing bank", "dbs bank", "uob bank",
        "icbc", "bank of china", "mizuho", "mufg", "smbc",
        "emirates nbd", "mashreq", "national bank of kuwait",
        "qnb", "saudi national bank", "itau", "wells fargo",
        "bank of america", "anz bank", "nab bank", "shinhan",
        "kookmin", "correspondent bank", "iso 20022", "iso20022",
    ),
}
