      ...
      <DialogContent className="max-h-[92vh] overflow-hidden p-0 sm:max-w-4xl border-neutral-200 dark:border-[#333] bg-white dark:bg-[#121212] rounded-sm gap-0 [&>button:last-child]:hidden">
        ...
        <div className="grid min-h-[600px] md:grid-cols-[1.05fr_0.95fr] relative">
          ...
          <button 
            ...
            className="absolute right-4 top-4 z-50 flex h-8 w-8 items-center justify-center rounded-sm bg-black/20 text-white hover:bg-black/40 transition md:bg-black/40 md:hover:bg-[#B2F273]"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
          ...
          <div className="relative flex flex-col justify-center px-6 py-10 sm:px-12">
            ...
            {blockers.length > 0 ? (
              <div className="mt-6 rounded-sm border border-[#B2F273]/20 bg-[#B2F273]/5 px-4 py-3">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    id={`${mode}-email`}
                    autoComplete="email"
                    className="h-11 rounded-sm border-neutral-300 dark:border-white/10 bg-white dark:bg-[#0A0A0A] pl-10 text-sm focus-visible:ring-1 focus-visible:ring-[#B2F273] focus-visible:ring-offset-0 disabled:opacity-50 text-neutral-900 dark:text-white"
              ...
              <button
                type="submit"
                className="mt-2 flex h-11 w-full items-center justify-center rounded-sm bg-[#B2F273] text-[13px] font-bold uppercase tracking-widest text-neutral-900 transition hover:bg-[#9AD65E] disabled:bg-neutral-300 disabled:text-neutral-500 dark:disabled:bg-neutral-700 dark:disabled:text-neutral-400 disabled:cursor-not-allowed"
          ...
          <div className="relative hidden w-full h-full bg-[#050505] md:flex overflow-hidden">
            ...
            <div className="relative z-10 p-12 flex flex-col justify-end w-full h-full">
              <div className="inline-flex items-center gap-2 mb-4">
                <div className="w-1.5 h-1.5 rounded-full bg-[#B2F273] animate-pulse" />
