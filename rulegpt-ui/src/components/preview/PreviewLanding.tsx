    ...
    <div className="min-h-screen bg-white font-sans text-neutral-900 selection:bg-[#FF4F00] selection:text-white pb-0">
      ...
      <section className="relative w-full min-h-screen md:h-screen md:min-h-[700px] flex items-center bg-[#050B14] overflow-hidden py-24 md:py-0">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Gradient fade to edges — keeps center clean for text */}
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,#050B14_75%)]" />
          {/* Bottom fade for section transition */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#050B14] via-transparent to-[#050B14]/60" />
          {/* Amber accent glow */}
          <div className="absolute -top-32 right-1/4 w-[500px] h-[500px] bg-[#FF4F00]/8 blur-[150px] rounded-full mix-blend-screen" />
        </div>
