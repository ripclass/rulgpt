...
export function UpgradeCTA({ tier }: { tier: SessionTier }) {
  ...
  return (
    <div className="rounded-sm bg-neutral-50 dark:bg-[#141414] border border-neutral-200 dark:border-white/10 px-4 py-4 transition-colors">
      ...
      <Button asChild className="mt-4 w-full rounded-sm bg-[#00261C] text-xs font-bold uppercase tracking-widest text-white transition hover:bg-[#B2F273] hover:text-neutral-900 shadow-sm shadow-[#B2F273]/20 border-none">
