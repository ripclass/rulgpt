...
export function Terms() {
  return (
    ...
    >
      ...
      >
        <div>
          <h2 className="heading-md" style={{ color: 'var(--color-parchment)' }}>Product scope</h2>
        ...
        <div>
          <h2 className="heading-md" style={{ color: 'var(--color-parchment)' }}>User responsibility</h2>
        ...
        <div>
          <h2 className="heading-md" style={{ color: 'var(--color-parchment)' }}>Availability</h2>
