...
export function Upgrade() {
  ...
  return (
    ...
    >
      {checkoutMessage ? (
        <div className="mb-8 rounded-sm border border-[#00261C] dark:border-[#B2F273]/20 bg-[#00261C] dark:bg-[#B2F273]/5 px-5 py-4">
          <p className="text-sm font-medium text-[#00261C] dark:text-[#B2F273]">{checkoutMessage}</p>
        </div>
      ) : null}
          ...
          return (
            <button
              ...
              className={`rounded-sm p-6 text-left transition border ${
                selected
                  ? 'border-[#00261C] dark:border-[#B2F273] bg-[#00261C] dark:bg-[#B2F273]/5 dark:bg-[#00261C] dark:bg-[#B2F273]/10 shadow-md shadow-[#00261C] dark:shadow-[#B2F273]/5'
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                {selected ? (
                  <span className="rounded-sm px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest bg-[#00261C] dark:bg-[#B2F273]/10 text-[#00261C] dark:text-[#B2F273]">
                    Selected
                  </span>
                ) : null}
              </div>
              ...
              <ul className="mt-5 space-y-2.5">
                {planCopy.features.map((feature: string) => (
                  <li key={feature} className="flex items-center gap-3 text-[13px] font-medium text-neutral-600 dark:text-neutral-300">
                    <Check className="h-4 w-4 text-[#00261C] dark:text-[#B2F273] shrink-0" /> {feature}
                  </li>
                ))}
              </ul>
            </button>
      ...
      <div className="mt-10 flex flex-wrap items-center gap-4 pt-8 border-t border-neutral-200 dark:border-white/10">
        <button
          className="inline-flex h-12 items-center justify-center rounded-sm bg-[#00261C] dark:bg-[#B2F273] px-10 text-xs font-bold uppercase tracking-widest text-white transition hover:bg-[#B2F273] hover:text-neutral-900 dark:hover:bg-[#00261C] dark:hover:text-white disabled:bg-neutral-300 disabled:text-neutral-500 dark:disabled:bg-neutral-700 dark:disabled:text-neutral-400 disabled:cursor-not-allowed shadow-lg shadow-[#00261C] dark:shadow-[#B2F273]/20"
          onClick={() => {
